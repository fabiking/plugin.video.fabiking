# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Fabiking Television - Kodi Add-on Copyright by Juarrox (juarrox@gmail.com)
...
def main_list(params):
    ...
    # Control del skin de Fabiking-television
    mastermenu = xml_skin()
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':  # Default skin
            ...
            if id_pastebin == "":
                ...
                if mastermenu == "":
                    plugintools.log("[PalcoTV.xml_skin: No definido")
                    mastermenu = 'hhttp://pastebin.com/raw.php?i=RBEDZWqN'
